  ...
  <div class="min-h-screen pt-20">
    <div class="container mx-auto px-6 py-12">
      ...
      <template v-else>
        ...
        <section v-if="profileContent" class="mb-20">
          <GlassCard class="p-8 md:p-12 max-w-4xl mx-auto">
            <div class="flex items-center gap-3 mb-8">
              <div class="w-10 h-10 bg-gradient-to-br from-primary-400 to-secondary-500 rounded-lg flex items-center justify-center text-white font-bold">
                👤
              </div>
        ...
        <!-- About Website -->
        <section v-if="websiteContent" class="mb-20">
          <GlassCard class="p-8 md:p-12 max-w-4xl mx-auto">
            <div class="flex items-center gap-3 mb-8">
              <div class="w-10 h-10 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-lg flex items-center justify-center text-white text-lg font-bold">
                🌐
              </div>
              <h2 class="text-2xl font-bold text-gray-900 dark:text-white">
        ...
        <!-- About Miya -->
        <section v-if="miyaContent" class="mb-20">
          <GlassCard class="p-8 md:p-12 max-w-4xl mx-auto">
            <div class="flex items-center gap-3 mb-8">
              <div class="w-10 h-10 bg-gradient-to-br from-pink-400 to-purple-500 rounded-lg flex items-center justify-center text-white text-lg font-bold">
                M
              </div>
              <h2 class="text-2xl font-bold text-gray-900 dark:text-white">
        ...
        <!-- Stats (from stats content or defaults) -->
        <section v-if="statsContent || defaultStats.length" class="mb-12">
          <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <GlassCard v-for="stat in displayStats" :key="stat.label" class="p-6 text-center">
...
onMounted(async () => {
  try {
    ...
    // Fallback: try loading all contents
    try {
